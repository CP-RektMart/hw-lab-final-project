...
module ascii_rom(
	...
	always @*
		case(addr_reg)
            ...
            12'h825: data = 8'b01000110;
            12'h826: data = 8'b10100110;
            12'h827: data = 8'b11100110;
            12'h828: data = 8'b01000110;
            ...
            12'h848: data = 8'b11010110;	//
            12'h849: data = 8'b11100110;	//
			...
			12'h894: data = 8'b00000010;	//
			12'h895: data = 8'b00000100;	//
			12'h896: data = 8'b01101000;	//
			12'h897: data = 8'b11010110;	//
			12'h898: data = 8'b01100110;	//
			12'h899: data = 8'b11000110;	//
			12'h89a: data = 8'b01101100;	//
			12'h89b: data = 8'b00111000;	//

...
module ascii_rom(
	...
	always @*
		case(addr_reg)
			...
			11'h615: data = 8'b00110110;	//
			11'h616: data = 8'b11001110;	//
			11'h617: data = 8'b11000110;	//
			11'h618: data = 8'b11000110;	//
			11'h619: data = 8'b11000110;	//
			11'h61a: data = 8'b01101110;	//
			...
			11'h625: data = 8'b11011000;	//
			11'h626: data = 8'b11101100;	//
			11'h627: data = 8'b11000110;	//
			11'h628: data = 8'b11000110;	//
			11'h629: data = 8'b11000110;	//
			11'h62a: data = 8'b11101100;	//
			11'h62b: data = 8'b11011000;	//
			...
			11'h637: data = 8'b11000110;	//
			11'h638: data = 8'b11000000;	//
			11'h639: data = 8'b11000110;	//
			...
			11'h65a: data = 8'b01100110;	//
			11'h65b: data = 8'b00111100;	//
			...
			11'h664: data = 8'b01100110;	//
			11'h665: data = 8'b01100000;	//
			11'h666: data = 8'b01100000;	//
			11'h667: data = 8'b11111110;	//
			11'h668: data = 8'b01100000;	//
			11'h669: data = 8'b01100000;	//
			11'h66a: data = 8'b01100000;	//
			11'h66b: data = 8'b01100000;	//
			...
			11'h675: data = 8'b00111011;	//-
			11'h676: data = 8'b01000110;	//
			11'h677: data = 8'b11000110;	//
			11'h678: data = 8'b11000110;	//
			11'h679: data = 8'b11000110;	//
			11'h67a: data = 8'b01000110;	//
			11'h67b: data = 8'b00111100;	//-
			11'h67c: data = 8'b00000110;	//
			11'h67d: data = 8'b11000110;	//
			11'h67e: data = 8'b00111000;	//-
			...
			11'h6a2: data = 8'b00011000;	//
			11'h6a3: data = 8'b00011000;	//
			11'h6a4: data = 8'b00000000;	//
			11'h6a5: data = 8'b00111100;	//-
			11'h6a6: data = 8'b00001100;	//
			11'h6a7: data = 8'b00001100;	//
			11'h6a8: data = 8'b00001100;	//
			11'h6a9: data = 8'b00001100;	//
			11'h6aa: data = 8'b00001100;	//
			11'h6ab: data = 8'b00001100;	//-
			11'h6ac: data = 8'b00001100;	//
			11'h6ad: data = 8'b11001100;	//
			11'h6ae: data = 8'b01111000;	//
			...
			11'h6b5: data = 8'b11000110;	//x
			11'h6b6: data = 8'b11001100;	//x
			11'h6b7: data = 8'b11010000;	//x
			11'h6b8: data = 8'b11100000;	//x
			11'h6b9: data = 8'b11010000;	//x
			11'h6ba: data = 8'b11001100;	//x
			11'h6bb: data = 8'b11000110;	//x
			...
			11'h6c5: data = 8'b01100000;	//x
			11'h6c6: data = 8'b01100000;	//x
			11'h6c7: data = 8'b01100000;	//x
			11'h6c8: data = 8'b01100000;	//x
			11'h6c9: data = 8'b01100000;	//x
			11'h6ca: data = 8'b01100000;	//x
			11'h6cb: data = 8'b00111100;	//x
			...
			11'h6d5: data = 8'b11101100;	//x
			11'h6d6: data = 8'b11010110;	//x
			11'h6d7: data = 8'b11010110;	//x
			11'h6d8: data = 8'b11010110;	//x
			11'h6d9: data = 8'b11010110;	//x
			11'h6da: data = 8'b11010110;	//x
			11'h6db: data = 8'b11000110;	//x
			...
			11'h6e5: data = 8'b10111100;	//x
			11'h6e6: data = 8'b11000110;	//x
			11'h6e7: data = 8'b11000110;	//x
			11'h6e8: data = 8'b11000110;	//x
			11'h6e9: data = 8'b11000110;	//x
			11'h6ea: data = 8'b11000110;	//x
			11'h6eb: data = 8'b11000110;	//x
			...
			11'h6f5: data = 8'b01111100;	//x
			11'h6f6: data = 8'b11000110;	//x
			11'h6f7: data = 8'b11000110;	//x
			11'h6f8: data = 8'b11000110;	//x
			11'h6f9: data = 8'b11000110;	//x
			11'h6fa: data = 8'b11000110;	//x
			11'h6fb: data = 8'b01111100;	//x
			...
			11'h705: data = 8'b11111100;	//x
			11'h706: data = 8'b11000110;	//x
			11'h707: data = 8'b11000110;	//x
			11'h708: data = 8'b11000110;	//x
			11'h709: data = 8'b11000110;	//x
			11'h70a: data = 8'b11000110;	//x
			11'h70b: data = 8'b11111100;	//x
			...
			11'h715: data = 8'b01111110;	//x
			11'h716: data = 8'b11000110;	//x
			11'h717: data = 8'b11000110;	//x
			11'h718: data = 8'b11000110;	//x
			11'h719: data = 8'b11000110;	//x
			11'h71a: data = 8'b11000110;	//x
			11'h71b: data = 8'b01111110;	//x
			...
			11'h725: data = 8'b10111100;	//x
			11'h726: data = 8'b11000010;	//x
			11'h727: data = 8'b11000000;	//x
			11'h728: data = 8'b11000000;	//x
			11'h729: data = 8'b11000000;	//x
			11'h72a: data = 8'b11000000;	//x
			11'h72b: data = 8'b11000000;	//x
			...
			11'h735: data = 8'b01111110;	//x
			11'h736: data = 8'b11000000;	//x
			11'h737: data = 8'b11000000;	//x
			11'h738: data = 8'b01111100;	//x
			11'h739: data = 8'b00000110;	//x
			11'h73a: data = 8'b00000110;	//x
			11'h73b: data = 8'b11111100;	//x
			...
			11'h742: data = 8'b11000000;	//-
			11'h743: data = 8'b11000000;	//-
			11'h744: data = 8'b11000000;	//-
			11'h745: data = 8'b11000000;	//x
			11'h746: data = 8'b11111000;	//x
			11'h747: data = 8'b11100000;	//x
			11'h748: data = 8'b11000000;	//x
			11'h749: data = 8'b11000110;	//x
			11'h74a: data = 8'b11000110;	//x
			11'h74b: data = 8'b01111100;	//x
			...
			11'h755: data = 8'b11000110;	//x
			11'h756: data = 8'b11000110;	//x
			11'h757: data = 8'b11000110;	//x
			11'h758: data = 8'b11000110;	//x
			11'h759: data = 8'b11000110;	//x
			11'h75a: data = 8'b11000110;	//x
			11'h75b: data = 8'b00111010;	//x
			...
			11'h765: data = 8'b11000110;	//x
			11'h766: data = 8'b11000110;	//x
			11'h767: data = 8'b11000110;	//x
			11'h768: data = 8'b11000110;	//x
			11'h769: data = 8'b01000100;	//x
			11'h76a: data = 8'b00101000;	//x
			11'h76b: data = 8'b00010000;	//x
			...
			11'h775: data = 8'b11000010;	//x
			11'h776: data = 8'b11000010;	//x
			11'h777: data = 8'b11011010;	//x
			11'h778: data = 8'b11011010;	//x
			11'h779: data = 8'b11011010;	//x
			11'h77a: data = 8'b01100110;	//x
			11'h77b: data = 8'b01000100;	//x
			...
			11'h785: data = 8'b11000110;	//x
			11'h786: data = 8'b11000110;	//x
			11'h787: data = 8'b01101100;	//x
			11'h788: data = 8'b00010000;	//x
			11'h789: data = 8'b01101100;	//x
			11'h78a: data = 8'b11000110;	//x
			11'h78b: data = 8'b11000110;	//x
			...
			11'h795: data = 8'b11000110;	//x
			11'h796: data = 8'b11000110;	//x
			11'h797: data = 8'b11000110;	//x
			11'h798: data = 8'b11000110;	//x
			11'h799: data = 8'b11000110;	//x
			11'h79a: data = 8'b01000110;	//x
			11'h79b: data = 8'b00111110;	//x
			11'h79c: data = 8'b00000110;	//-
			11'h79d: data = 8'b01000110;	//-
			11'h79e: data = 8'b00111110;	//-
			...
			11'h7a5: data = 8'b11111110;	//x
			11'h7a6: data = 8'b00000110;	//x
			11'h7a7: data = 8'b00001100;	//x
			11'h7a8: data = 8'b00011000;	//x
			11'h7a9: data = 8'b00110000;	//x
			11'h7aa: data = 8'b01100000;	//x
			11'h7ab: data = 8'b11111110;	//x

namespace eval ::optrace {
  variable script "C:/HwSynLab/Final_Project/Final_Project.runs/impl_1/top.tcl"
...
OPTRACE "create in-memory project" START { }
  ...
  set_property board_part_repo_paths {C:/Users/patth/AppData/Roaming/Xilinx/Vivado/2024.1.1/xhub/board_store/xilinx_board_store} [current_project]
  set_property board_part digilentinc.com:basys3:part0:1.2 [current_project]
  set_property design_mode GateLvl [current_fileset]
  set_param project.singleFileAddWarning.threshold 0
OPTRACE "create in-memory project" END { }
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/HwSynLab/Final_Project/Final_Project.cache/wt [current_project]
  set_property parent.project_path C:/HwSynLab/Final_Project/Final_Project.xpr [current_project]
  set_property ip_output_repo C:/HwSynLab/Final_Project/Final_Project.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/HwSynLab/Final_Project/Final_Project.runs/synth_1/top.dcp
OPTRACE "read constraints: implementation" START { }
  read_xdc C:/HwSynLab/Final_Project/Final_Project.srcs/constrs_1/imports/HwSynLab/Basys-3-Master.xdc
